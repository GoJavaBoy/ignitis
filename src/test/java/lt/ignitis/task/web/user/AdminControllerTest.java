...
public class AdminControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL)
                ...
                .andExpect(USER_MATCHER.contentJson(user, user1, user2, admin));
    }
    ...
    void getWithPosts() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + ADMIN_ID + "/with-posts")
                .with(userHttpBasic(admin)))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_WITH_POSTS_MATCHER.contentJson(admin));
    }
